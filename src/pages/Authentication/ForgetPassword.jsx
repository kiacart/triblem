...
const ForgetPasswordPage = (props) => {
  //meta title
  document.title =
    "Forget Password | Triblem &Dashboard";
  ...
  const validation = useFormik({
    ...
    validationSchema: Yup.object({
      email: Yup.string().required("Please Enter Your Email").email('Enter vaild Email Address'),
    }),
    onSubmit: (values) => {
                  ...
                  <Row> 
                    ...
                    <Col xs={12}>
                      <div className="text-primary p-4 pb-0">
                        ...
                        <p>Enter Email Id to get password reset instructions.</p>
                      </div>
                    </Col>
