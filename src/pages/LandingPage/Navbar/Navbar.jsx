       ...
       <nav className={"navbar navbar-expand-lg navigation fixed-top sticky " + navClass} id="navbar">
                <Container>
                    <Link className="navbar-logo" to="/">
                        ...
                        <img src={logoDark} alt="" height="50" width='50' className="logo logo-dark" />
                        {/* <img src={logoLight} alt="" height="19" className="logo logo-light" /> */}
                        <img src={logoLight} alt="" height="50" width='50' className="logo logo-light" />
                    </Link>
                    ...
                    >
                        ...
                        <div className="my-2 ms-lg-2">
                            <Link to="/login" className="btn btn-info w-xs">Sign in</Link>
                        </div>
                    </Collapse>
                </Container>
            </nav>
